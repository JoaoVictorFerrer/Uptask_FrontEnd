...
export default function TaskList({ tasks, canEdit }: TasksListProp) {
  ...
  const handleDragEnd = (e: DragEndEvent) => {
    ...
    if (over && over.id) {
      ...
      /**Actualizacion optimista sin esperar la respuesta del servidor actualizando el state manualmente */
        ...
        <DndContext onDragEnd={handleDragEnd}>
          {Object.entries(groupedTasks).map(([status, tasks]) => (
            <div key={status} className="min-w-[300px] 2xl:min-w-0 2xl:w-1/5">
              ...
              {/* hago que itere en mi objeto con esta nomeclatura acciendo a los valores en funcion de cada key */}
